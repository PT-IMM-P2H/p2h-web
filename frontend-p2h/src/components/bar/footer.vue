...
<template>
  <footer
    class="fixed bottom-0 left-0 right-0 bg-white shadow-lg font-['Montserrat'] z-40"
  >
    <!-- Main Footer Content -->
    <div class="px-2 py-2 md:px-6 md:py-4 w-full">
      ...
      >
        ...
        <div
          class="flex items-center gap-3 justify-center md:justify-start shrink-0"
        >
          <img src="/image_asset/IMM.svg" alt="IMM Logo" class="w-20 h-auto" />
        ...
        >
          <PhoneIcon class="w-4 md:w-5 h-4 md:h-5 text-[#3b82f6] shrink-0" />
