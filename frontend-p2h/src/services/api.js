...
const apiService = {
  ...
  bulkUpload: {
    ...
    downloadVehiclesPtTemplate: () => api.get('/bulk-upload/templates/vehicles-pt', { responseType: 'blob' }),
    downloadVehiclesTravelTemplate: () => api.get('/bulk-upload/templates/vehicles-travel', { responseType: 'blob' }),
